...
import { d, w, h, fled, fle,pad, bc, ff, fw, lets, clr, text, fs, m, texd, hov, linh, b, flew, jc, ai, pos, zi} from "../../styles/themes";
                ...
                <div className={css(d.flex, w.w_100)} >
                    <div className={css(d.flex, w.w_100, fled.r,)}>
                        <div className={css(d.flex, fled.c, fle.flex_2,  pad.lg, bc.white_smoke)}>
                            ...
                            <div className={css(d.flex, bc.white, fled.r, m.mg_t_lg)}>
                                ...
                                <div className={css(d.flex, fled.c, pad.md, fle.flex_1, m.mg_l_md,)}>
                                    ...
                                    <a href={"https://baomoi.com"+source} className={css(texd.none, clr.black, hov.trans_color_dgray)}>
                                        {"https://baomoi.com"+source}
                                    </a>
                                </div>
                            </div>
                        </div>
